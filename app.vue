      ...
      <div class=" text-gray-800 justify-self-center">
        ...
        <div ref="pdf" class="custom-font-regular bg-white text-2xl p-6max-w-4xl mx-auto bg-white p-8 shadow-lg"
          ...
          <div class="grid grid-cols-12">
            ...
            <div class="p-8  col-span-8">
              <h3 class="text-3xl font-bold mb-4 border-b-4 border-black pb-4">EXPERIENCE</h3>
...
// import fontref = "./assets/jspdf/Inter-VariableFont_opsz,wght-normal.js"
import "./assets/jspdf/Bytesized-Regular-normal"

const linkedin = useTemplateRef("linkedin")
const github = useTemplateRef("github")
const ezlo = useTemplateRef("ezlo")
const metric = useTemplateRef("metric")
const nurd = useTemplateRef("nurd")
const ginoa = useTemplateRef("ginoa")
...
const createPdf2 = () => {
  ...
  doc.html(pdf.value, {
    ...
    callback: function (doc_e) {
      ...
      [{ el: linkedin.value.getBoundingClientRect(), url: "https://www.linkedin.com/in/efe-g%C3%BCre-5a47b0b9/" }
        , { el: github.value.getBoundingClientRect(), url: "https://github.com/efegure" }
